...
export const taskRowSchema = z.object({
  ...
  /** P7-73 — this task's values for its list's custom fields, keyed by field id. */
...
/** P7-68 — one checklist step: `qk.taskPart(id, "checklist")`, in `position` order. */
...
/** P13-01 — somebody who may be handed work in the collaboration space. */
export const collaboratorSchema = z.object({
  id: z.uuid(),
  full_name: z.string(),
});

/** P7-59 — the request row, which RLS returns to department leads only. */
