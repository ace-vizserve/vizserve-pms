...
export function makeQueryClient() {
  ...
  /*
   * Reference data inherits the long stale time BY KEY PREFIX, so a future
   * `["ref", …]` entry cannot forget it. Invalidation still cuts through it;
   * this only decides whether a mount refetches.
   */
