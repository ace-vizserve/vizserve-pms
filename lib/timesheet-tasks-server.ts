...
import {
  ...
  loadLoggableTasksByIds as loadLoggableTasksByIdsWith,
...
export async function loadLoggableTasksByIds(userId: string, ids: string[]) {
  return loadLoggableTasksByIdsWith(await createClient(), userId, ids);
}
