...
| **7 — Personal tasks, overtime, timesheet approval** | **Done — backend and screens.** Twenty-five migrations live, P7-32 through P7-39 included — all applied and verified against the dev project on 24 Aug. **P7-35 holiday calendar needs no migration** and works as deployed. **P7-36 to P7-40 = the smart DTR** — see below |
