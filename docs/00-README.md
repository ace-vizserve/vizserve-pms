...
| D30 | **The audit report is scoped by what the caller leads, and says so on the page.** `vizserve_pms_leave_report` gives an admin everyone, a lead their own departments, and a member an empty set rather than an error — "you lead nobody" is a true answer to the question. The generated PDF prints the year, the date, who ran it and the scope, because it exists to be compared against HR's manual count and two documents that disagree are useless unless each states what it counted. **Leavers are included** where they took leave in the year, flagged rather than dropped: their absences are part of the year being audited whether or not they are still on the payroll | User, 24 Aug 2026 |
