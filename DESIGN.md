...
:root {
  ...
  --gradient-rainbow-conic: conic-gradient(
    from 90deg,
    rgb(125, 91, 231) 19%,
    rgb(188, 63, 218) 28%,
    rgb(250, 36, 206) 37%,
  ...
  --gradient-primary-gradient: linear-gradient(
    83deg,
    rgba(64, 221, 255) -5%,
    rgba(118, 18, 250) 51%,
    rgba(250, 18, 227) 125%
  ...
  --shadow-subtle-2:
    rgba(18, 43, 165, 0.04) 0px 1px 1px -0.5px, rgba(18, 43, 165, 0.04) 0px 3px 3px -1.5px,
    rgba(18, 43, 165, 0.04) 0px 6px 6px -3px, rgba(18, 43, 165, 0.04) 0px 12px 12px -6px;
  ...
  --shadow-subtle-3:
    rgba(255, 255, 255, 0.1) 0px 0.5px 0px 0px inset, rgba(255, 255, 255, 0.1) 0px -0.5px 0px 0px inset;
